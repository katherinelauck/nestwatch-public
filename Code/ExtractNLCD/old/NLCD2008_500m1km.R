...
#pt <- read.csv('Saved/Points_WithNLCD2008.csv', header=T)
...
pt <- read.csv('~/Google Drive/NestwatchProject/Saved/Points_WithNLCD2008.csv', header=T)
...
csvName1 <- "Saved/NLCD2008_500m1km.csv"

...
#from lab computer
lc <- raster('~/Documents/ElissaOlimpi/NLCD/NLCD_2004_Land_Cover_L48_20190424.img')
pt <- read.csv('~/Google Drive/NestwatchProject/Saved/Points_WithNLCD2004.csv', header=T)
...
csvName1 <- "Saved/NLCD2004_500m1km.csv"

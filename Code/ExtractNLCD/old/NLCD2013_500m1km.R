...
#pt <- read.csv('Saved/Points_WithNLCD2013.csv', header=T)
#lc <- raster('GIS/NLCD/NLCD_2013_Land_Cover_L48_20190424.img')

#from lab computer
lc <- raster('~/Documents/ElissaOlimpi/NLCD/NLCD_2013_Land_Cover_L48_20190424.img')
pt <- read.csv('~/Google Drive/NestwatchProject/Saved/Points_WithNLCD2013.csv', header=T)
...
csvName1 <- "Saved/NLCD2013_500m1km.csv"

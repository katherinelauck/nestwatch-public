...
#lc <- raster('GIS/NLCD/NLCD_2016_Land_Cover_AK_20200213.img')

#from lab computer
lc <- raster('~/Documents/ElissaOlimpi/NLCD/NLCD_2016_Land_Cover_AK_20200213.img')
...
write.csv(pt, "Saved/Points_WithNLCD2016_AK.csv", row.names=F)
pt2 <- pt
coordinates(pt2)  <-  c("LONGITUDE",  "LATITUDE")
proj4string(pt2)  <- CRS("+proj=longlat +ellps=WGS84 +datum=WGS84")
#reproject coords to match NLCD
...
csvName1 <- "Saved/NLCD2016_AK_2km.csv"

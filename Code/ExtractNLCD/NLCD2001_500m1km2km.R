...
#lc <- raster('GIS/NLCD/NLCD_2001_Land_Cover_L48_20190424.img')

#from lab computer
lc <- raster('~/Documents/ElissaOlimpi/NLCD/NLCD_2001_Land_Cover_L48_20190424.img')
...
csvName1 <- "Saved/NLCD2001_500m1km2km.csv"

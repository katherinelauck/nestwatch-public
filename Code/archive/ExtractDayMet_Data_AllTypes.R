...
DayCentOneSite=function(lat, lon, dates, days_prior, days_after){
  ...
  colnames(WeatherData)=c("noanomoly_mean_precip" ,"noanomoly_max_tmax" ,"noanomoly_min_tmin" ,"noanomoly_mean_tmean","mean_anamoly_mean_precip" ,"mean_anamoly_max_tmax" ,"mean_anamoly_min_tmin" ,"mean_anamoly_mean_tmean","z_anamoly_mean_precip" ,"z_anamoly_max_tmax" ,"z_anamoly_min_tmin" ,"z_anamoly_mean_tmean")
...
errorCATCH_daymet=function(i,days_prior,days_after){
  ...
  if(class(weather)[1]=="try-error"){
    weather=array(dim=c(dim(oneSITE)[1],12),"NA")
...
colnames(DayMetData)=c("UnID","AttemptID","noanomoly_mean_precip" ,"noanomoly_max_tmax" ,"noanomoly_min_tmin" ,"noanomoly_mean_tmean","mean_anamoly_mean_precip" ,"mean_anamoly_max_tmax" ,"mean_anamoly_min_tmin" ,"mean_anamoly_mean_tmean","z_anamoly_mean_precip" ,"z_anamoly_max_tmax" ,"z_anamoly_min_tmin" ,"z_anamoly_mean_tmean")
...
fname=paste("~/Google Drive/NestwatchProject/Data/","DayMetData_",Batch,"_365prior.csv",sep="")
...
######################
rm(list=ls())
batch_1=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_1_45after.csv",header=TRUE)[,2:15]
batch_2=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_2_45after.csv",header=TRUE)[,2:15]
batch_3=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_3_45after.csv",header=TRUE)[,2:15]
batch_4=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_4_45after.csv",header=TRUE)[,2:15]
batch_5=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_5_45after.csv",header=TRUE)[,2:15]
batch_6=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_6_45after.csv",header=TRUE)[,2:15]
DayMetData_45=rbind(batch_1,batch_2,batch_3,batch_4,batch_5,batch_6)

batch_1=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_1_365prior.csv",header=TRUE)[,2:15]
batch_2=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_2_365prior.csv",header=TRUE)[,2:15]
batch_3=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_3_365prior.csv",header=TRUE)[,2:15]
batch_4=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_4_365prior.csv",header=TRUE)[,2:15]
batch_5=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_5_365prior.csv",header=TRUE)[,2:15]
batch_6=read.csv("~/Google Drive/NestwatchProject/Data/DayMetData_6_365prior.csv",header=TRUE)[,2:15]
...
################################
colnames(DayMetData_45)[3:14]=paste(colnames(DayMetData_45)[3:14],"Next45",sep="_")
DayMetData_45$NotCalculated_Next45=0
DayMetData_45$NotCalculated_Next45[which(is.na(DayMetData_45$mean_anamoly_mean_precip_Next45)==TRUE)]=1
head(DayMetData_45)

colnames(DayMetData_365)[3:14]=paste(colnames(DayMetData_365)[3:14],"Prior365",sep="_")
DayMetData_365 $NotCalculated_Prior365=0
DayMetData_365 $NotCalculated_Prior365[which(is.na(DayMetData_365 $mean_anamoly_mean_precip_Prior365)==TRUE)]=1
head(DayMetData_365)

######################
# Compile Everything #
######################
DayMetData=cbind(DayMetData_45,DayMetData_365[3:15])
save(DayMetData,file="~/Google Drive/NestwatchProject/Data/DayMetData.RData")

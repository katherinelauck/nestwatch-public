...
# setting name of job
#SBATCH --job-name=mainv1_elextemp_human_lienar
...
cat Code/Analyses/revisions/mainv1_elextemp_human_lienar.R
...
Rscript Code/Analyses/revisions/mainv1_elextemp_human_lienar.R

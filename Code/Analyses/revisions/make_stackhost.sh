...
#SBATCH --job-name=make_stackhost                                               # setting name of job
#SBATCH -c 1                                                                    # number of cores
#SBATCH --mem=1G                                                              # setting the memory per cpu
#SBATCH -t 0-10:00:00                                                            # setting the max time
...
echo "## Script:"
cat Code/Analyses/revisions/make_stackhost.R
echo "## Mesh:" $1
echo "## Output:"
...
# Run script
Rscript Code/Analyses/revisions/make_stackhost.R $1

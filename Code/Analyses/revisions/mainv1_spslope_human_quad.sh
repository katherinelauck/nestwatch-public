...
# setting name of job
#SBATCH --job-name=mainv1_spslope_human_quad
...
cat Code/Analyses/revisions/mainv1_spslope_human_quad.R
...
Rscript Code/Analyses/revisions/mainv1_spslope_human_quad.R

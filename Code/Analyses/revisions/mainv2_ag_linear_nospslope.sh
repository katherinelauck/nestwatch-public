...
# setting name of job
#SBATCH --job-name=mainv2_ag_linear_nospslope
...
cat Code/Analyses/revisions/mainv2_ag_linear_nospslope.R
...
Rscript Code/Analyses/revisions/mainv2_ag_linear_nospslope.R

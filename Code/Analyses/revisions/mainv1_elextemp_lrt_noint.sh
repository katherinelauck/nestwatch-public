...
# setting name of job
#SBATCH --job-name=mainv1_elextemp_lrt_noint
...
cat Code/Analyses/revisions/mainv1_elextemp_lrt_noint.R
...
Rscript Code/Analyses/revisions/mainv1_elextemp_lrt_noint.R

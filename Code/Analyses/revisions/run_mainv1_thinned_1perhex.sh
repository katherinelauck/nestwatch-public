...
# setting name of job
#SBATCH --job-name=run_mainv1_thinned_1perhex
...
cat Code/Analyses/revisions/run_mainv1_thinned_1perhex.R
...
Rscript Code/Analyses/revisions/run_mainv1_thinned_1perhex.R

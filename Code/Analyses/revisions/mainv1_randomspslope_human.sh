...
# setting name of job
#SBATCH --job-name=mainv1_randomspslope_human
...
cat Code/Analyses/revisions/mainv1_randomspslope_human.R
...
Rscript Code/Analyses/revisions/mainv1_randomspslope_human.R

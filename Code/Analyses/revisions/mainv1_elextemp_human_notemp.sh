...
# setting name of job
#SBATCH --job-name=mainv1_elextemp_human_notemp
...
cat Code/Analyses/revisions/mainv1_elextemp_human_notemp.R
...
Rscript Code/Analyses/revisions/mainv1_elextemp_human_notemp.R

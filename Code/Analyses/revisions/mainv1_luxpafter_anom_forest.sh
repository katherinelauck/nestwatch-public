...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_anom_forest
...
cat Code/Analyses/revisions/mainv1_luxpafter_anom_forest.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_anom_forest.R

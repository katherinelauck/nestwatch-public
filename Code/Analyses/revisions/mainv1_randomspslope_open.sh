...
# setting name of job
#SBATCH --job-name=mainv1_randomspslope_open
...
cat Code/Analyses/revisions/mainv1_randomspslope_open.R
...
Rscript Code/Analyses/revisions/mainv1_randomspslope_open.R

...
# setting name of job
#SBATCH --job-name=run_mainv2_on_thinned_data
...
cat Code/Analyses/revisions/run_mainv2_on_thinned_data.R
...
Rscript Code/Analyses/revisions/run_mainv2_on_thinned_data.R

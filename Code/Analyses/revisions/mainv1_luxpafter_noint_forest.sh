...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_noint_forest
...
cat Code/Analyses/revisions/mainv1_luxpafter_noint_forest.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_noint_forest.R

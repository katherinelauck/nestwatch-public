...
# setting name of job
#SBATCH --job-name=run_region_models_on_lab_compy
...
cat Code/Analyses/revisions/run_region_models_on_lab_compy.R
...
Rscript Code/Analyses/revisions/run_region_models_on_lab_compy.R

...
# setting name of job
#SBATCH --job-name=mainv1_region150latelevation
...
cat Code/Analyses/revisions/mainv1_region150latelevation.R
...
Rscript Code/Analyses/revisions/mainv1_region150latelevation.R

...
# setting name of job
#SBATCH --job-name=mainv1_withregion_linear
...
cat Code/Analyses/revisions/mainv1_withregion_linear.R
...
Rscript Code/Analyses/revisions/mainv1_withregion_linear.R

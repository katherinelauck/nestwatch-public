...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_anom_lrt
...
cat Code/Analyses/revisions/mainv1_luxpafter_anom_lrt.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_anom_lrt.R

...
# setting name of job
#SBATCH --job-name=mainv2_eletemp_lrtlinear
...
cat Code/Analyses/revisions/mainv2_eletemp_lrtlinear.R
...
Rscript Code/Analyses/revisions/mainv2_eletemp_lrtlinear.R

...
mod <- glmer(formula = at_least_one_success ~ Tmax_std_gridmet * NewLU1 + NewLU1 * cavity_binary + 
...
write_rds(mod,"results/revisions/cavity_stdmaxlaydate3way_spslope_double.rds")

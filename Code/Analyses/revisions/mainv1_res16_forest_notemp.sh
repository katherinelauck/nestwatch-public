...
# setting name of job
#SBATCH --job-name=mainv1_res16_forest_notemp
...
cat Code/Analyses/revisions/mainv1_res16_forest_notemp.R
...
Rscript Code/Analyses/revisions/mainv1_res16_forest_notemp.R

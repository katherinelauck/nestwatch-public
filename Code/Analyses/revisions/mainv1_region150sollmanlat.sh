...
# setting name of job
#SBATCH --job-name=mainv1_region150sollmanlat
...
cat Code/Analyses/revisions/mainv1_region150sollmanlat.R
...
Rscript Code/Analyses/revisions/mainv1_region150sollmanlat.R

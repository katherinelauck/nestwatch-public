...
# setting name of job
#SBATCH --job-name=mainv1_region150eletempspslope
...
cat Code/Analyses/revisions/mainv1_region150eletempspslope.R
...
Rscript Code/Analyses/revisions/mainv1_region150eletempspslope.R

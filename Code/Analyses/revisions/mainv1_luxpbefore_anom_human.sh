...
# setting name of job
#SBATCH --job-name=mainv1_luxpbefore_anom_human
...
cat Code/Analyses/revisions/mainv1_luxpbefore_anom_human.R
...
Rscript Code/Analyses/revisions/mainv1_luxpbefore_anom_human.R

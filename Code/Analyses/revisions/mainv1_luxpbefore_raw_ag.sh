...
# setting name of job
#SBATCH --job-name=mainv1_luxpbefore_raw_ag
...
cat Code/Analyses/revisions/mainv1_luxpbefore_raw_ag.R
...
Rscript Code/Analyses/revisions/mainv1_luxpbefore_raw_ag.R

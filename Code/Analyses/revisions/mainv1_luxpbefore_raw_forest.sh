...
# setting name of job
#SBATCH --job-name=mainv1_luxpbefore_raw_forest
...
cat Code/Analyses/revisions/mainv1_luxpbefore_raw_forest.R
...
Rscript Code/Analyses/revisions/mainv1_luxpbefore_raw_forest.R

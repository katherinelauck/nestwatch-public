...
# setting name of job
#SBATCH --job-name=run_mainv1_thinned_oneperhex
...
cat Code/Analyses/revisions/run_mainv1_thinned_oneperhex.R
...
Rscript Code/Analyses/revisions/run_mainv1_thinned_oneperhex.R

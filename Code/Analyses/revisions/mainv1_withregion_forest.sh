...
# setting name of job
#SBATCH --job-name=mainv1_withregion_forest
...
cat Code/Analyses/revisions/mainv1_withregion_forest.R
...
Rscript Code/Analyses/revisions/mainv1_withregion_forest.R

...
# setting name of job
#SBATCH --job-name=mainv1_luxpbefore_anom_lrt
...
cat Code/Analyses/revisions/mainv1_luxpbefore_anom_lrt.R
...
Rscript Code/Analyses/revisions/mainv1_luxpbefore_anom_lrt.R

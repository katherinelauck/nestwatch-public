...
hex_res <- seq(7,20) # res 6 approximately corresponds to 200km between centers of neighboring hexes. See: http://cran.nexr.com/web/packages/dggridR/vignettes/dggridR.html and convert area to side length

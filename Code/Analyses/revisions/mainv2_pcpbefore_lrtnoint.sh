...
# setting name of job
#SBATCH --job-name=mainv2_pcpbefore_lrtnoint
...
cat Code/Analyses/revisions/mainv2_pcpbefore_lrtnoint.R
...
Rscript Code/Analyses/revisions/mainv2_pcpbefore_lrtnoint.R

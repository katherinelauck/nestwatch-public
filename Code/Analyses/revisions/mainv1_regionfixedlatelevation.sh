...
# setting name of job
#SBATCH --job-name=mainv1_regionfixedlatelevation
...
cat Code/Analyses/revisions/mainv1_regionfixedlatelevation.R
...
Rscript Code/Analyses/revisions/mainv1_regionfixedlatelevation.R

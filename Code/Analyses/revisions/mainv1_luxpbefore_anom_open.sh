...
# setting name of job
#SBATCH --job-name=mainv1_luxpbefore_anom_open
...
cat Code/Analyses/revisions/mainv1_luxpbefore_anom_open.R
...
Rscript Code/Analyses/revisions/mainv1_luxpbefore_anom_open.R

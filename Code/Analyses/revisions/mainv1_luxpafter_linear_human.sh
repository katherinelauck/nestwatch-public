...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_linear_human
...
cat Code/Analyses/revisions/mainv1_luxpafter_linear_human.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_linear_human.R

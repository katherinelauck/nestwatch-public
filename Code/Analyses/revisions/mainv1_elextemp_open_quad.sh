...
# setting name of job
#SBATCH --job-name=mainv1_elextemp_open_quad
...
cat Code/Analyses/revisions/mainv1_elextemp_open_quad.R
...
Rscript Code/Analyses/revisions/mainv1_elextemp_open_quad.R

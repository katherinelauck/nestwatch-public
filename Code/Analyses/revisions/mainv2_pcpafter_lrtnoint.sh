...
# setting name of job
#SBATCH --job-name=mainv2_pcpafter_lrtnoint
...
cat Code/Analyses/revisions/mainv2_pcpafter_lrtnoint.R
...
Rscript Code/Analyses/revisions/mainv2_pcpafter_lrtnoint.R

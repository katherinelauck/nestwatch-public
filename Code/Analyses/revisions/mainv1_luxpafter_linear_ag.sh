...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_linear_ag
...
cat Code/Analyses/revisions/mainv1_luxpafter_linear_ag.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_linear_ag.R

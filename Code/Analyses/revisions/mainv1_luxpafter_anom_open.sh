...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_anom_open
...
cat Code/Analyses/revisions/mainv1_luxpafter_anom_open.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_anom_open.R

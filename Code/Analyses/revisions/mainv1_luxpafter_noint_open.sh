...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_noint_open
...
cat Code/Analyses/revisions/mainv1_luxpafter_noint_open.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_noint_open.R

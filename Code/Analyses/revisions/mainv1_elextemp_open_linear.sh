...
# setting name of job
#SBATCH --job-name=mainv1_elextemp_open_linear
...
cat Code/Analyses/revisions/mainv1_elextemp_open_linear.R
...
Rscript Code/Analyses/revisions/mainv1_elextemp_open_linear.R

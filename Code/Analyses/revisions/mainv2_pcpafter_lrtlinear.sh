...
# setting name of job
#SBATCH --job-name=mainv2_pcpafter_lrtlinear
...
cat Code/Analyses/revisions/mainv2_pcpafter_lrtlinear.R
...
Rscript Code/Analyses/revisions/mainv2_pcpafter_lrtlinear.R

...
# setting name of job
#SBATCH --job-name=mainv1_spslope_ag_linear
...
cat Code/Analyses/revisions/mainv1_spslope_ag_linear.R
...
Rscript Code/Analyses/revisions/mainv1_spslope_ag_linear.R

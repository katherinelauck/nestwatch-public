...
# setting name of job
#SBATCH --job-name=mainv1_region150eletemplat
...
cat Code/Analyses/revisions/mainv1_region150eletemplat.R
...
Rscript Code/Analyses/revisions/mainv1_region150eletemplat.R

...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_linear_forest
...
cat Code/Analyses/revisions/mainv1_luxpafter_linear_forest.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_linear_forest.R

...
# setting name of job
#SBATCH --job-name=mainv1_randomspslope_forest
...
cat Code/Analyses/revisions/mainv1_randomspslope_forest.R
...
Rscript Code/Analyses/revisions/mainv1_randomspslope_forest.R

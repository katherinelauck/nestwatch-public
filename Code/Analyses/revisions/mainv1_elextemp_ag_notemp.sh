...
# setting name of job
#SBATCH --job-name=mainv1_elextemp_ag_notemp
...
cat Code/Analyses/revisions/mainv1_elextemp_ag_notemp.R
...
Rscript Code/Analyses/revisions/mainv1_elextemp_ag_notemp.R

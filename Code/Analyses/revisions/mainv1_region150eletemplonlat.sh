...
# setting name of job
#SBATCH --job-name=mainv1_region150eletemplonlat
...
cat Code/Analyses/revisions/mainv1_region150eletemplonlat.R
...
Rscript Code/Analyses/revisions/mainv1_region150eletemplonlat.R

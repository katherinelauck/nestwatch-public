...
# setting name of job
#SBATCH --job-name=mainv2_pcpbefore_lrtlinear
...
cat Code/Analyses/revisions/mainv2_pcpbefore_lrtlinear.R
...
Rscript Code/Analyses/revisions/mainv2_pcpbefore_lrtlinear.R

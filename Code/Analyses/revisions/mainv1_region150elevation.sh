...
# setting name of job
#SBATCH --job-name=mainv1_region150elevation
...
cat Code/Analyses/revisions/mainv1_region150elevation.R
...
Rscript Code/Analyses/revisions/mainv1_region150elevation.R

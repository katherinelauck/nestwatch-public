...
# setting name of job
#SBATCH --job-name=mainv1_luxpbefore_quad_open
...
cat Code/Analyses/revisions/mainv1_luxpbefore_quad_open.R
...
Rscript Code/Analyses/revisions/mainv1_luxpbefore_quad_open.R

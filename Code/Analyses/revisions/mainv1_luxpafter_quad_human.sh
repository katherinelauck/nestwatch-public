...
# setting name of job
#SBATCH --job-name=mainv1_luxpafter_quad_human
...
cat Code/Analyses/revisions/mainv1_luxpafter_quad_human.R
...
Rscript Code/Analyses/revisions/mainv1_luxpafter_quad_human.R

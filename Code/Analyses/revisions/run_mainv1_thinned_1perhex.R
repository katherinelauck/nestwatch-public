...
hex_res <- seq(10,30) # res 6 approximately corresponds to 200km between centers of neighboring hexes. See: http://cran.nexr.com/web/packages/dggridR/vignettes/dggridR.html and convert area to side length
...
model <- function(data,name) {
  ...
  write_rds(mod,paste0("results/revisions/mainv1_1perhex",name,"quad.rds"))
  ...
  write_rds(data,paste0("results/revisions/mainv1_1perhex",name,"data.rds"))
}

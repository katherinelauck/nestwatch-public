...
# setting name of job
#SBATCH --job-name=mainv1_randomspslope_lrt
...
cat Code/Analyses/revisions/mainv1_randomspslope_lrt.R
...
Rscript Code/Analyses/revisions/mainv1_randomspslope_lrt.R

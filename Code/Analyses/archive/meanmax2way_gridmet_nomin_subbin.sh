...
# setting name of job
#SBATCH --job-name=meanmax2way_gridmet_nomin_subbin
...
cat Code/Analyses/meanmax2way_gridmet_nomin_subbin.R
...
Rscript Code/Analyses/meanmax2way_gridmet_nomin_subbin.R

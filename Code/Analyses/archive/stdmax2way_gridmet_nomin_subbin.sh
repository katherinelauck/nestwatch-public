...
# setting name of job
#SBATCH --job-name=stdmax2way_gridmet_nomin_subbin
...
cat Code/Analyses/stdmax2way_gridmet_nomin_subbin.R
...
Rscript Code/Analyses/stdmax2way_gridmet_nomin_subbin.R

...
# setting name of job
#SBATCH --job-name=meanmax2way_gridmet_nomin_subfixed
...
cat Code/Analyses/meanmax2way_gridmet_nomin_subfixed.R
...
Rscript Code/Analyses/meanmax2way_gridmet_nomin_subfixed.R

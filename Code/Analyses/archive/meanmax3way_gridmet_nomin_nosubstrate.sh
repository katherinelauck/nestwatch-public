...
# setting name of job
#SBATCH --job-name=meanmax3way_gridmet_nomin_nosubstrate
...
cat Code/Analyses/meanmax3way_gridmet_nomin_nosubstrate.R
...
Rscript Code/Analyses/meanmax3way_gridmet_nomin_nosubstrate.R

...
# setting name of job
#SBATCH --job-name=meanmax3way_gridmet_nomin_subfixed
...
cat Code/Analyses/meanmax3way_gridmet_nomin_subfixed.R
...
Rscript Code/Analyses/meanmax3way_gridmet_nomin_subfixed.R

...
# setting name of job
#SBATCH --job-name=meanmax2way_gridmet_nomin_nosubstrate
...
cat Code/Analyses/meanmax2way_gridmet_nomin_nosubstrate.R
...
Rscript Code/Analyses/meanmax2way_gridmet_nomin_nosubstrate.R

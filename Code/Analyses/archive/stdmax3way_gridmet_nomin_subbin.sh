...
# setting name of job
#SBATCH --job-name=stdmax3way_gridmet_nomin_subbin
...
cat Code/Analyses/stdmax3way_gridmet_nomin_subbin.R
...
Rscript Code/Analyses/stdmax3way_gridmet_nomin_subbin.R

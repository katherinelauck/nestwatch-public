...
# setting name of job
#SBATCH --job-name=meanmax3way_gridmet_nomin_subbin
...
cat Code/Analyses/meanmax3way_gridmet_nomin_subbin.R
...
Rscript Code/Analyses/meanmax3way_gridmet_nomin_subbin.R

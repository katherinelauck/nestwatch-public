...
# setting name of job
#SBATCH --job-name=failure~BBSstdmaxlaydate3way.AK
...
cat Code/Analyses/q4/failure~BBSstdmaxlaydate3way.AK.R
...
Rscript Code/Analyses/q4/failure~BBSstdmaxlaydate3way.AK.R

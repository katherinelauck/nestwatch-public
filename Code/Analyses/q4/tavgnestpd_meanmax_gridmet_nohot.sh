...
# setting name of job
#SBATCH --job-name=tavgnestpd_meanmax_gridmet_nohot
...
cat Code/Analyses/q4/tavgnestpd_meanmax_gridmet_nohot.R
...
Rscript Code/Analyses/q4/tavgnestpd_meanmax_gridmet_nohot.R

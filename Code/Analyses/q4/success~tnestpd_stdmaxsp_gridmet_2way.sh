...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_2way
...
cat Code/Analyses/q4/success~tnestpd_stdmaxsp_gridmet_2way.R
...
Rscript Code/Analyses/q4/success~tnestpd_stdmaxsp_gridmet_2way.R

...
# setting name of job
#SBATCH --job-name=tnestpd_meanmax_gridmet_3way
...
cat Code/Analyses/q4/success~tnestpd_meanmax_gridmet_3way.R
...
Rscript Code/Analyses/q4/success~tnestpd_meanmax_gridmet_3way.R

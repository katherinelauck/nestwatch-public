...
# setting name of job
#SBATCH --job-name=tavgnestpd_meanmax_gridmet_Human_3way
...
cat Code/Analyses/q4/tavgnestpd_meanmax_gridmet_Human_3way.R
...
Rscript Code/Analyses/q4/tavgnestpd_meanmax_gridmet_Human_3way.R

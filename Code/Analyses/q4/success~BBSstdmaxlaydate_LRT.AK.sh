...
# setting name of job
#SBATCH --job-name=BBSstdmaxlaydate_LRT.AK
...
cat Code/Analyses/q4/success~BBSstdmaxlaydate_LRT.AK.R
...
Rscript Code/Analyses/q4/success~BBSstdmaxlaydate_LRT.AK.R

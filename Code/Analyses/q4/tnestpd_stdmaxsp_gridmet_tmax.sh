...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_tmax
...
cat Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_tmax.R
...
Rscript Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_tmax.R

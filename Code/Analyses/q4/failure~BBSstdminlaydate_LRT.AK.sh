...
# setting name of job
#SBATCH --job-name=failure~BBSstdminlaydate_LRT.AK
...
cat Code/Analyses/q4/failure~BBSstdminlaydate_LRT.AK.R
...
Rscript Code/Analyses/q4/failure~BBSstdminlaydate_LRT.AK.R

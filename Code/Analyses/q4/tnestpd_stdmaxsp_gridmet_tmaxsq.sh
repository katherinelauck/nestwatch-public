...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_tmaxsq
...
cat Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_tmaxsq.R
...
Rscript Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_tmaxsq.R

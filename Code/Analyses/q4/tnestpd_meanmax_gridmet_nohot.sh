...
# setting name of job
#SBATCH --job-name=tnestpd_meanmax_gridmet_nohot
...
cat Code/Analyses/q4/tnestpd_meanmax_gridmet_nohot.R
...
Rscript Code/Analyses/q4/tnestpd_meanmax_gridmet_nohot.R

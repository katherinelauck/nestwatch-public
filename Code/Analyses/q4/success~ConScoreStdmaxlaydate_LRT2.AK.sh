...
# setting name of job
#SBATCH --job-name=ConScoreStdmaxlaydate_LRT2.AK
...
cat Code/Analyses/q4/success~ConScoreStdmaxlaydate_LRT2.AK.R
...
Rscript Code/Analyses/q4/success~ConScoreStdmaxlaydate_LRT2.AK.R

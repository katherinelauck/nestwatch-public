...
# setting name of job
#SBATCH --job-name=tnestpd_rel2sheard_anom_2way
...
cat Code/Analyses/q4/tnestpd_rel2sheard_anom_2way.R
...
Rscript Code/Analyses/q4/tnestpd_rel2sheard_anom_2way.R

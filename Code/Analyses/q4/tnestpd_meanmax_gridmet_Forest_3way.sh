...
# setting name of job
#SBATCH --job-name=tnestpd_meanmax_gridmet_Forest_3way
...
cat Code/Analyses/q4/tnestpd_meanmax_gridmet_Forest_3way.R
...
Rscript Code/Analyses/q4/tnestpd_meanmax_gridmet_Forest_3way.R

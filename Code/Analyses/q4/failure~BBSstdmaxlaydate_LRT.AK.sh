...
# setting name of job
#SBATCH --job-name=failure~BBSstdmaxlaydate_LRT.AK
...
cat Code/Analyses/q4/failure~BBSstdmaxlaydate_LRT.AK.R
...
Rscript Code/Analyses/q4/failure~BBSstdmaxlaydate_LRT.AK.R

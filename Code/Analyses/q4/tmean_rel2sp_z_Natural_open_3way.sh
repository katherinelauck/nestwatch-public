...
# setting name of job
#SBATCH --job-name=tmean_rel2sp_z_Natural_open_3way
...
cat Code/Analyses/q4/tmean_rel2sp_z_Natural_open_3way.R
...
Rscript Code/Analyses/q4/tmean_rel2sp_z_Natural_open_3way.R

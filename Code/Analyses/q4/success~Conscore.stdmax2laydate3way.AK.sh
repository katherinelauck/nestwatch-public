...
# setting name of job
#SBATCH --job-name=Conscore.stdmax2laydate3way.AK
...
cat Code/Analyses/q4/success~Conscore.stdmax2laydate3way.AK.R
...
Rscript Code/Analyses/q4/success~Conscore.stdmax2laydate3way.AK.R

...
# setting name of job
#SBATCH --job-name=BBSstdmax2laydate3way.AK
...
cat Code/Analyses/q4/success~BBSstdmax2laydate3way.AK.R
...
Rscript Code/Analyses/q4/success~BBSstdmax2laydate3way.AK.R

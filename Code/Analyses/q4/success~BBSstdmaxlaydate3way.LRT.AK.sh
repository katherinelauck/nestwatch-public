...
# setting name of job
#SBATCH --job-name=BBSstdmaxlaydate3way.LRT.AK
...
cat Code/Analyses/q4/success~BBSstdmaxlaydate3way.LRT.AK.R
...
Rscript Code/Analyses/q4/success~BBSstdmaxlaydate3way.LRT.AK.R

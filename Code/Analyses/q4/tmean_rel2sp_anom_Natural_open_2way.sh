...
# setting name of job
#SBATCH --job-name=tmean_rel2sp_anom_Natural_open_2way
...
cat Code/Analyses/q4/tmean_rel2sp_anom_Natural_open_2way.R
...
Rscript Code/Analyses/q4/tmean_rel2sp_anom_Natural_open_2way.R

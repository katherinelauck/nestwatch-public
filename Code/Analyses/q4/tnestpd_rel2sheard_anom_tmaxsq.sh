...
# setting name of job
#SBATCH --job-name=tnestpd_rel2sheard_anom_tmaxsq
...
cat Code/Analyses/q4/tnestpd_rel2sheard_anom_tmaxsq.R
...
Rscript Code/Analyses/q4/tnestpd_rel2sheard_anom_tmaxsq.R

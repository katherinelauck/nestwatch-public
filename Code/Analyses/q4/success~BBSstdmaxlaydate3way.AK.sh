...
# setting name of job
#SBATCH --job-name=BBSstdmaxlaydate3way.AK
...
cat Code/Analyses/q4/success~BBSstdmaxlaydate3way.AK.R
...
Rscript Code/Analyses/q4/success~BBSstdmaxlaydate3way.AK.R

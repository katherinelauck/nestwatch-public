...
# setting name of job
#SBATCH --job-name=BBSstdmaxlaydate_LRT2.AK
...
cat Code/Analyses/q4/success~BBSstdmaxlaydate_LRT2.AK.R
...
Rscript Code/Analyses/q4/success~BBSstdmaxlaydate_LRT2.AK.R

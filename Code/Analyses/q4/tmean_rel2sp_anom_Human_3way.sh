...
# setting name of job
#SBATCH --job-name=tmean_rel2sp_anom_Human_3way
...
cat Code/Analyses/q4/tmean_rel2sp_anom_Human_3way.R
...
Rscript Code/Analyses/q4/tmean_rel2sp_anom_Human_3way.R

...
# setting name of job
#SBATCH --job-name=tavgnestpd_meanmax_gridmet_tmaxsq
...
cat Code/Analyses/q4/tavgnestpd_meanmax_gridmet_tmaxsq.R
...
Rscript Code/Analyses/q4/tavgnestpd_meanmax_gridmet_tmaxsq.R

...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_Human_2way
...
cat Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_Human_2way.R
...
Rscript Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_Human_2way.R

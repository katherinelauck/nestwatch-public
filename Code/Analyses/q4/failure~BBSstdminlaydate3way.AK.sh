...
# setting name of job
#SBATCH --job-name=failure~BBSstdminlaydate3way.AK
...
cat Code/Analyses/q4/failure~BBSstdminlaydate3way.AK.R
...
Rscript Code/Analyses/q4/failure~BBSstdminlaydate3way.AK.R

...
# setting name of job
#SBATCH --job-name=ConScoreStdmaxlaydate_LRT3.AK
...
cat Code/Analyses/q4/success~ConScoreStdmaxlaydate_LRT3.AK.R
...
Rscript Code/Analyses/q4/success~ConScoreStdmaxlaydate_LRT3.AK.R

...
# setting name of job
#SBATCH --job-name=tavgnestpd_meanmax_gridmet_noint
...
cat Code/Analyses/q4/tavgnestpd_meanmax_gridmet_noint.R
...
Rscript Code/Analyses/q4/tavgnestpd_meanmax_gridmet_noint.R

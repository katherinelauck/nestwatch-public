...
# setting name of job
#SBATCH --job-name=tnestpd_meanmax_gridmet_noint
...
cat Code/Analyses/q4/tnestpd_meanmax_gridmet_noint.R
...
Rscript Code/Analyses/q4/tnestpd_meanmax_gridmet_noint.R

...
# setting name of job
#SBATCH --job-name=tnestpd_meanmax_gridmet_tmaxsq
...
cat Code/Analyses/q4/tnestpd_meanmax_gridmet_tmaxsq.R
...
Rscript Code/Analyses/q4/tnestpd_meanmax_gridmet_tmaxsq.R

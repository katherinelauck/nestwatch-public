...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_noint
...
cat Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_noint.R
...
Rscript Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_noint.R

...
# setting name of job
#SBATCH --job-name=tavgnestpd_meanmax_gridmet_tmax
...
cat Code/Analyses/q4/tavgnestpd_meanmax_gridmet_tmax.R
...
Rscript Code/Analyses/q4/tavgnestpd_meanmax_gridmet_tmax.R

...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_Ag_3way
...
cat Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_Ag_3way.R
...
Rscript Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_Ag_3way.R

...
# setting name of job
#SBATCH --job-name=tnestpd_rel2sheard_z_Human_3way
...
cat Code/Analyses/q4/tnestpd_rel2sheard_z_Human_3way.R
...
Rscript Code/Analyses/q4/tnestpd_rel2sheard_z_Human_3way.R

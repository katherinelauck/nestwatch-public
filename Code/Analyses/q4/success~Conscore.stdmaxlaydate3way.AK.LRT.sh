...
# setting name of job
#SBATCH --job-name=Conscore.stdmaxlaydate3way.AK.LRT
...
cat Code/Analyses/q4/success~Conscore.stdmaxlaydate3way.AK.LRT.R
...
Rscript Code/Analyses/q4/success~Conscore.stdmaxlaydate3way.AK.LRT.R

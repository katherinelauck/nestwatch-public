...
# setting name of job
#SBATCH --job-name=tavgnestpd_meanmax_gridmet_Natural_open_2way
...
cat Code/Analyses/q4/tavgnestpd_meanmax_gridmet_Natural_open_2way.R
...
Rscript Code/Analyses/q4/tavgnestpd_meanmax_gridmet_Natural_open_2way.R

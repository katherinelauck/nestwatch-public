...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_3way
...
cat Code/Analyses/q4/success~tnestpd_stdmaxsp_gridmet_3way.R
...
Rscript Code/Analyses/q4/success~tnestpd_stdmaxsp_gridmet_3way.R

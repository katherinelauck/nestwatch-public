...
# setting name of job
#SBATCH --job-name=tnestpd_stdmaxsp_gridmet_nohot
...
cat Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_nohot.R
...
Rscript Code/Analyses/q4/tnestpd_stdmaxsp_gridmet_nohot.R

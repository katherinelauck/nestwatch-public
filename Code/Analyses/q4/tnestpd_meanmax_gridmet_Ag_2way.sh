...
# setting name of job
#SBATCH --job-name=tnestpd_meanmax_gridmet_Ag_2way
...
cat Code/Analyses/q4/tnestpd_meanmax_gridmet_Ag_2way.R
...
Rscript Code/Analyses/q4/tnestpd_meanmax_gridmet_Ag_2way.R

...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.forest.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.forest.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.forest.AK.R

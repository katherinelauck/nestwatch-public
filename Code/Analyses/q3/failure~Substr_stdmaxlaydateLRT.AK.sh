...
# setting name of job
#SBATCH --job-name=failure~Substr_stdmaxlaydateLRT.AK
...
cat Code/Analyses/q3/failure~Substr_stdmaxlaydateLRT.AK.R
...
Rscript Code/Analyses/q3/failure~Substr_stdmaxlaydateLRT.AK.R

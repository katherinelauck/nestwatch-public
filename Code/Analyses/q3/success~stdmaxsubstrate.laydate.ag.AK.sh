...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.ag.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.ag.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.ag.AK.R

...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.human.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.human.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.human.LRT.AK.R

...
# setting name of job
#SBATCH --job-name=Substr_stdminlaydateLRT.AK
...
cat Code/Analyses/q3/success~Substr_stdminlaydateLRT.AK.R
...
Rscript Code/Analyses/q3/success~Substr_stdminlaydateLRT.AK.R

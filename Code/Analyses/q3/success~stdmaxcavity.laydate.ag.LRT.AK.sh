...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.ag.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.ag.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.ag.LRT.AK.R

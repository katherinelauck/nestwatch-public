...
# setting name of job
#SBATCH --job-name=Substr_stdminlaydate3way.AK
...
cat Code/Analyses/q3/success~Substr_stdminlaydate3way.AK.R
...
Rscript Code/Analyses/q3/success~Substr_stdminlaydate3way.AK.R

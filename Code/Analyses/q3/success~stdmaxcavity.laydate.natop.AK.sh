...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.natop.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.natop.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.natop.AK.R

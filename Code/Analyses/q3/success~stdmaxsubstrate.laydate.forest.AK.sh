...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.forest.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.forest.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.forest.AK.R

...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.ag.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.ag.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.ag.AK.R

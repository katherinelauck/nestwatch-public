...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.human.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.human.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.human.AK.R

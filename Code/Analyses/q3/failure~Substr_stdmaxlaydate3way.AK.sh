...
# setting name of job
#SBATCH --job-name=failure~Substr_stdmaxlaydate3way.AK
...
cat Code/Analyses/q3/failure~Substr_stdmaxlaydate3way.AK.R
...
Rscript Code/Analyses/q3/failure~Substr_stdmaxlaydate3way.AK.R

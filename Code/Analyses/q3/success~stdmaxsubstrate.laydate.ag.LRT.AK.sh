...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.ag.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.ag.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.ag.LRT.AK.R

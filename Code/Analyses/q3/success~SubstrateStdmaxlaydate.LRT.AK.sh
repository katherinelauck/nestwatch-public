...
# setting name of job
#SBATCH --job-name=SubstrateStdmaxlaydate.LRT.AK
...
cat Code/Analyses/q3/success~SubstrateStdmaxlaydate.LRT.AK.R
...
Rscript Code/Analyses/q3/success~SubstrateStdmaxlaydate.LRT.AK.R

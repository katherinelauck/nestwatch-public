...
# setting name of job
#SBATCH --job-name=failure~Substr_stdminlaydateLRT.AK
...
cat Code/Analyses/q3/failure~Substr_stdminlaydateLRT.AK.R
...
Rscript Code/Analyses/q3/failure~Substr_stdminlaydateLRT.AK.R

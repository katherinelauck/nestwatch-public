...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.for.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.for.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.for.LRT.AK.R

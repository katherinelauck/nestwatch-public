...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.natop.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.natop.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.natop.AK.R

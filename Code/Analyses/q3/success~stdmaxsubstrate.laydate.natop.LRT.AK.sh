...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.natop.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.natop.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.natop.LRT.AK.R

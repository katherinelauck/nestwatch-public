...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.human.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.human.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.human.AK.R

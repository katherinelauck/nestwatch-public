...
# setting name of job
#SBATCH --job-name=stdmaxsubstrate.laydate.human.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxsubstrate.laydate.human.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxsubstrate.laydate.human.LRT.AK.R

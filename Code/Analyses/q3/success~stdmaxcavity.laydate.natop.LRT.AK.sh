...
# setting name of job
#SBATCH --job-name=stdmaxcavity.laydate.natop.LRT.AK
...
cat Code/Analyses/q3/success~stdmaxcavity.laydate.natop.LRT.AK.R
...
Rscript Code/Analyses/q3/success~stdmaxcavity.laydate.natop.LRT.AK.R

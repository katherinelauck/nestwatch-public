...
# setting name of job
#SBATCH --job-name=failure~stdmax2laydate_LRT_AK
...
cat Code/Analyses/q12/failure~stdmax2laydate_LRT_AK.R
...
Rscript Code/Analyses/q12/failure~stdmax2laydate_LRT_AK.R

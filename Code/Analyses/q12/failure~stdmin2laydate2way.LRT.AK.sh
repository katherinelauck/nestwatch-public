...
# setting name of job
#SBATCH --job-name=failure~stdmin2laydate2way.LRT.AK
...
cat Code/Analyses/q12/failure~stdmin2laydate2way.LRT.AK.R
...
Rscript Code/Analyses/q12/failure~stdmin2laydate2way.LRT.AK.R

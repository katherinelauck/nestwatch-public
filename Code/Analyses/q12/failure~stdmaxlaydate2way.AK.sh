...
# setting name of job
#SBATCH --job-name=failure~stdmaxlaydate2way.AK
...
cat Code/Analyses/q12/failure~stdmaxlaydate2way.AK.R
...
Rscript Code/Analyses/q12/failure~stdmaxlaydate2way.AK.R

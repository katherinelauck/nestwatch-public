...
# setting name of job
#SBATCH --job-name=failure~stdmin2laydate_LRT_AK
...
cat Code/Analyses/q12/failure~stdmin2laydate_LRT_AK.R
...
Rscript Code/Analyses/q12/failure~stdmin2laydate_LRT_AK.R

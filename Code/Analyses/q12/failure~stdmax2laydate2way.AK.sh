...
# setting name of job
#SBATCH --job-name=failure~stdmax2laydate2way.AK
...
cat Code/Analyses/q12/failure~stdmax2laydate2way.AK.R
...
Rscript Code/Analyses/q12/failure~stdmax2laydate2way.AK.R

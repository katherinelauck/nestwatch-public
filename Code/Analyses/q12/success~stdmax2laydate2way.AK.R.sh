...
# setting name of job
#SBATCH --job-name=stdmax2laydate2way.AK.R
...
cat Code/Analyses/q12/success~stdmax2laydate2way.AK.R.R
...
Rscript Code/Analyses/q12/success~stdmax2laydate2way.AK.R.R

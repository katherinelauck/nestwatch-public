...
# setting name of job
#SBATCH --job-name=stdmin2laydate2way.LRT.AK
...
cat Code/Analyses/q12/success~stdmin2laydate2way.LRT.AK.R
...
Rscript Code/Analyses/q12/success~stdmin2laydate2way.LRT.AK.R

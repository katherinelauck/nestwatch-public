...
# setting name of job
#SBATCH --job-name=stdmax2laydate2way.LRT.AK
...
cat Code/Analyses/q12/success~stdmax2laydate2way.LRT.AK.R
...
Rscript Code/Analyses/q12/success~stdmax2laydate2way.LRT.AK.R

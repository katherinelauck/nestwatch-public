...
# setting name of job
#SBATCH --job-name=failure~stdmin2laydate2way.AK
...
cat Code/Analyses/q12/failure~stdmin2laydate2way.AK.R
...
Rscript Code/Analyses/q12/failure~stdmin2laydate2way.AK.R

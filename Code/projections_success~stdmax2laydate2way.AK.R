...
m1 <- readRDS('results/predictions/success~tmean_rel2sp_anom_tmax.rds')
...
int.Tmax.tmean_anom <- fixef[20,1]
...
success_projections$y.fut.rcp45e.gfdl.mean <-  inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet.rcp45e.gfdl.mean + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet.rcp45e.gfdl.mean_sq + tmean_rel2sp_anom*success_projections$tmean_rel2sp_anom +
                                                           ...
                                                           int.Tmax.tmean_anom*success_projections$Tmax_std_gridmet.rcp45e.gfdl.mean*success_projections$tmean_rel2sp_anom)

success_projections$y.now.rcp45e.gfdl.mean<- 0
success_projections$y.now.rcp45e.gfdl.mean <- inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet  + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet_sq + tmean_rel2sp_anom*success_projections$tmean_rel2sp_anom +
...
success_projections$y.fut.rcp45e.gfdl.10 <-  inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet.rcp45e.gfdl.10 + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet.rcp45e.gfdl.10_sq +tmean_rel2sp_anom*success_projections$tmean_rel2sp_anom +
...
success_projections$y.now.rcp45e.gfdl.10 <- inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet  + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet_sq + tmean_rel2sp_anom*success_projections$tmean_rel2sp_anom +
                                                          PcpBefore_raw_gridmet*success_projections$pcpbefore_raw_gridmet + success_projections$laydate_scaled * laydate_scaled +
                                                          NLCD_p_forest*success_projections$NLCD_p_forest + NLCD_p_human*success_projections$NLCD_p_human  + NLCD_p_ag*success_projections$NLCD_p_ag  +
                                                          substrate*success_projections$substrate_binary +
                                                          success_projections$LU + success_projections$int*success_projections$Tmax_std_gridmet +
...
success_projections$y.fut.rcp45e.gfdl.90 <-  inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet.rcp45e.gfdl.90 + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet.rcp45e.gfdl.90_sq +
...
success_projections$y.now.rcp45e.gfdl.90 <- inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet  + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet_sq +
                                                        PcpBefore_raw_gridmet*success_projections$pcpbefore_raw_gridmet + success_projections$laydate_scaled * laydate_scaled +
                                                        NLCD_p_forest*success_projections$NLCD_p_forest + NLCD_p_human*success_projections$NLCD_p_human  + NLCD_p_ag*success_projections$NLCD_p_ag  +
                                                        substrate*success_projections$substrate_binary +
                                                        success_projections$LU + success_projections$int*success_projections$Tmax_std_gridmet +
...
###Aqui meto las de 85 para hacer una prueba
...
success_projections$y.now.rcp85e.gfdl.mean <- inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet  + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet_sq +
                                                          PcpBefore_raw_gridmet*success_projections$pcpbefore_raw_gridmet + success_projections$laydate_scaled * laydate_scaled +
                                                          NLCD_p_forest*success_projections$NLCD_p_forest + NLCD_p_human*success_projections$NLCD_p_human  + NLCD_p_ag*success_projections$NLCD_p_ag  +
                                                          substrate*success_projections$substrate_binary +
                                                          success_projections$LU + success_projections$int*success_projections$Tmax_std_gridmet +
...
success_projections$y.now.rcp85e.gfdl.10 <- inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet  + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet_sq +
                                                        PcpBefore_raw_gridmet*success_projections$pcpbefore_raw_gridmet + success_projections$laydate_scaled * laydate_scaled +
                                                        NLCD_p_forest*success_projections$NLCD_p_forest + NLCD_p_human*success_projections$NLCD_p_human  + NLCD_p_ag*success_projections$NLCD_p_ag  +
                                                        substrate*success_projections$substrate_binary +
                                                        success_projections$LU + success_projections$int*success_projections$Tmax_std_gridmet +
...
success_projections$y.now.rcp85e.gfdl.90 <- inv.logit(intercept + Tmax_std_gridmet*success_projections$Tmax_std_gridmet  + Tmax_std_gridmet_sq*success_projections$Tmax_std_gridmet_sq +
                                                        PcpBefore_raw_gridmet*success_projections$pcpbefore_raw_gridmet + success_projections$laydate_scaled * laydate_scaled +
                                                        NLCD_p_forest*success_projections$NLCD_p_forest + NLCD_p_human*success_projections$NLCD_p_human  + NLCD_p_ag*success_projections$NLCD_p_ag  +
                                                        substrate*success_projections$substrate_binary +
                                                        success_projections$LU + success_projections$int*success_projections$Tmax_std_gridmet +
...
success_projections.ag.rcp45e.gfdl <- subset(success_projections, NewLU1 =="Ag")
success_projections.forest.rcp45e.gfdl <- subset(success_projections, NewLU1 =="Forest")
success_projections.natural.open.rcp45e.gfdl <- subset(success_projections, NewLU1 =="Natural_open")
success_projections.human.rcp45e.gfdl <- subset(success_projections, NewLU1 =="Human")

##Plots difference in success_projections
g.density.y.dif.rcp45e.gfdl.mean.ag <- ggplot(success_projections.ag.rcp45e.gfdl, aes(x=y.dif.rcp45e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+xlim(min=-0.06,max=0.06) +
  geom_density(fill ="coral2", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Agriculture")+ ylab("Density")+ xlab("Future - Now")

g.density.y.dif.rcp45e.gfdl.mean.ag

g.density.y.dif.rcp45e.gfdl.mean.forest <- ggplot(success_projections.forest.rcp45e.gfdl, aes(x=y.dif.rcp45e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+xlim(min=-0.06,max=0.06) +
  geom_density(fill ="springgreen4", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Forest")+ ylab("Density")+ xlab("Future - Now")

g.density.y.dif.rcp45e.gfdl.mean.forest

g.density.y.dif.rcp45e.gfdl.mean.natural.open <- ggplot(success_projections.natural.open.rcp45e.gfdl, aes(x=y.dif.rcp45e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+xlim(min=-0.06,max=0.06) +
  geom_density(fill ="mediumpurple3", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Natural Open")+ ylab("Density")+ xlab("Future - Now")

g.density.y.dif.rcp45e.gfdl.mean.natural.open

g.density.y.dif.rcp45e.gfdl.mean.human <- ggplot(success_projections.human.rcp45e.gfdl, aes(x=y.dif.rcp45e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+ xlim(min=-0.06,max=0.06) +
  geom_density(fill ="turquoise3", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Human")+ ylab("Density")+ xlab("Future - Now")
...
v1 <- rasterize(success_projections.ag.rcp45e.gfdl[,c(139,140)], dummy, success_projections.ag.rcp45e.gfdl[,148], fun=mean, background=NA, mask=FALSE, na.rm=T)

v2 <- as.data.frame(v1, xy=TRUE)

map <-  ggplot() + geom_raster(data = v2, aes(x=x, y=y, fill=layer))+ my.theme.map +
  geom_polygon(data = map.usa, aes(x=long, y = lat, group = group), fill = NA, color = "black")  +
  scale_fill_gradient2(name = "Future - Now",mid="grey69",low = "firebrick2",high = "royalblue2",limits = c(-0.03,0.03), oob = squish, na.value = 'white') 

map
  
  map <-  ggplot() + geom_point(data = v2, aes(x=x, y=y, color=layer), size=2)+ my.theme.map +
    geom_polygon(data = map.usa, aes(x=long, y = lat, group = group), fill = NA, color = "black")  +
    scale_color_gradient2(name = "Future - Now",mid="grey69",low = "firebrick2",high = "royalblue2",limits = c(-0.03,0.03), oob = squish,na.value = 'white') 
...
map.ag <- ggplot() + geom_polygon(data = map.usa, aes(x=long, y = lat, group = group), fill = NA, color = "black")  + my.theme.map +
  geom_point(data = success_projections.ag.rcp45e.gfdl, mapping = aes(x=lon, y=lat, colour = success_projections.ag.rcp45e.gfdl$y.dif.rcp45e.gfdl.mean), size =2, alpha = 0.5) +
  scale_color_gradient2(name = "Future - Now",mid="grey69",low = "firebrick2",high = "royalblue2",limits = c(-0.03,0.03), oob = squish) +
  ggtitle("")
map.ag

map.forest <- ggplot() + geom_polygon(data = map.usa, aes(x=long, y = lat, group = group), fill = NA, color = "black")  + my.theme.map +
  geom_point(data = success_projections.forest.rcp45e.gfdl, mapping = aes(x=lon, y=lat, colour = success_projections.forest.rcp45e.gfdl$y.dif.rcp45e.gfdl.mean),size =2, alpha =0.5) +
  scale_color_gradient2(name = "Future - Now",mid="grey48",low = "firebrick2",high = "royalblue2",limits = c(-0.03,0.03), oob = squish) +
  ggtitle("Forest")
map.forest

map.natural.open <- ggplot() + geom_polygon(data = map.usa, aes(x=long, y = lat, group = group), fill = NA, color = "black")  + my.theme.map +
  geom_point(data = success_projections.natural.open.rcp45e.gfdl, mapping = aes(x=lon, y=lat, colour = success_projections.natural.open.rcp45e.gfdl$y.dif.rcp45e.gfdl.mean),size =2, alpha =0.5) +
  scale_color_gradient2(name = "Future - Now",mid="grey48",low = "firebrick2",high = "royalblue2",limits = c(-0.03,0.03), oob = squish) +
  ggtitle("Natural open")
map.natural.open

map.human <- ggplot() + geom_polygon(data = map.usa, aes(x=long, y = lat, group = group), fill = NA, color = "black")  + my.theme.map +
  geom_point(data = success_projections.human.rcp45e.gfdl, mapping = aes(x=lon, y=lat, colour = success_projections.human.rcp45e.gfdl$y.dif.rcp45e.gfdl.mean),size =2, alpha =0.5) +
  scale_color_gradient2(name = "Future - Now",mid="grey48",low = "firebrick2",high = "royalblue2",limits = c(-0.03,0.03), oob = squish) +
  ggtitle("Human")
map.human

map.projection <- ggarrange(map.ag,map.forest,map.natural.open,map.human,nrow=2,ncol=2)
map.projection 
...
###Scatter plot with x = now y = future
g.now.rcp85e.gfdl.mean <- ggplot(success_projections, aes(x=y.now.rcp85e.gfdl.mean, y = y.fut.rcp85e.gfdl.mean))+xlim(min=0.5,max=0.85)+ylim(min=0.5,max=0.85)+my.theme+
  geom_point( aes(color=NewLU1),alpha=0.3, na.rm = TRUE)+
  geom_abline(intercept = 0, slope = 1,color="black", linetype = "dashed") +
  geom_smooth(method="lm",se=F)+
...
##Plots difference in success_projections
g.density.y.dif.rcp85e.gfdl.mean.ag <- ggplot(success_projections.ag.rcp85e.gfdl.mean , aes(x=y.dif.rcp85e.gfdl.mean ))+ my.theme + ylim(min=0,max=100) + xlim(min=-0.15,max=0.15) +
  geom_density(fill ="coral1", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Agriculture")+ ylab("Density")+ xlab("Future - Now")
...
g.density.y.dif.rcp85e.gfdl.mean.forest <- ggplot(success_projections.forest.rcp85e.gfdl.mean, aes(x=y.dif.rcp85e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+xlim(min=-0.15,max=0.15) +
  geom_density(fill ="springgreen4", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Forest")+ ylab("Density")+ xlab("Future - Now")
...
g.density.y.dif.rcp85e.gfdl.mean.natural.open <- ggplot(success_projections.natural.open.rcp85e.gfdl.mean, aes(x=y.dif.rcp85e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+xlim(min=-0.15,max=0.15) +
  geom_density(fill ="mediumpurple3", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Natural Open")+ ylab("Density")+ xlab("Future - Now")
...
g.density.y.dif.rcp85e.gfdl.mean.human <- ggplot(success_projections.human.rcp85e.gfdl.mean, aes(x=y.dif.rcp85e.gfdl.mean ))+ my.theme + ylim(min=0,max=100)+ xlim(min=-0.15,max=0.15) +
  geom_density(fill ="turquoise3", alpha=0.5) + 
  geom_vline(aes(xintercept=0),color="black", linetype="dashed", size=1)+
  ggtitle("Human")+ ylab("Density")+ xlab("Future - Now")

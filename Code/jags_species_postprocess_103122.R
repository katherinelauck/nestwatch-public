...
chains<-readRDS("~/Documents/nestwatch/results/revisions_jags/sp_analysis_jags_102622.RDS")
result<-readRDS("~/Documents/nestwatch/results/revisions_jags/sp_analysis_jags_summ_102622.RDS")
